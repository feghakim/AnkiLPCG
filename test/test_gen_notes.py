...
automatic_test_poem = dedent("""
    ...
    لِلْعَلَّامَةِ الشَّيخُ	 عُبَيْدِ رَبِّه: مُحَمَّدِ بْنِ آبَّه القلَّاوي الشِّنْقِيطِيّ
    المُتَوَفَّى فِي أَوَائِلِ القَرْنِ الثَّانِي عَشَرَ الهِجْرِيّ
    قَالَ العَلَّامَةُ الشَّيْخُ: عُبَيدُ رَبِّه مُحَمَّدُ آبَّهْ القَلَّاوِيُّ الشِّنْقِيطِيُّ، المُتَوَفَّى فِي أَوَائِلِ القَرْنِ الثَّانِي عَشَرَ فِي نَظْمِهِ: مُقَدِّمَةَ ابْنِ آجُرُّوم فِي النَّحْوِ:
